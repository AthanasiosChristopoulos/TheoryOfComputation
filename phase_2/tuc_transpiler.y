...
%type <str> complicated_types function_definition_comp function_definition_section return_type_comp use_comp_variable use_of_comp_variable use_comp_variable_with_period
...
use_of_comp_variable:
    %empty                                                  { $$ = ""; } 
  | use_of_comp_variable use_comp_variable_with_period      { $$ = template("%s%s", $1, $2); }
;

use_comp_variable_with_period:
  '#' IDENTIFIER                        { variable_name_temp = $2; $$ = template("%s", $2);}
;
